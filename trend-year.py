...
if len(datas)>0:
	...
	if ply=='yes':
		...
		if pval<=1-sig:
			...
			data = Data([trace0,trace1,trace2,trace22,trace3])
			layout=Layout(
		...
		#plot_url = py.plot(fig, filename=site + '_' + param + '_years_' + str(yrmin) + '-' + str(yrmax))
		py.image.save_as(fig,'fig_py/' + site + '_' + param + '_years_' + str(yrmin) + '-' + str(yrmax) + '.png')
